...
const MAX_BODY_AGE_MESSAGE =
  "Channel property maxBodyAgeDays has to be a number that's valid and requestBody or responseBody must be true."
const TIMEOUT_SECONDS_MESSAGE =
  'Channel property timeoutSeconds has to be a number greater than 1 and less than an 3600'
