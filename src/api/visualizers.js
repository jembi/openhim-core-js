...
export function* getVisualizer(visualizerId) {
    ...
    try {
        const result = yield Visualizer.findById(visualizerId).exec();
        if (!result) {
...
export function* addVisualizer() {
    ...
    try {
        const visualizer = new Visualizer(visualizerData);
...
export function* updateVisualizer(visualizerId) {
    ...
    try {
        const result = yield Visualizer.findByIdAndUpdate(visualizerId, visualizerData).exec();
        if (!result) {
...
export function* removeVisualizer(visualizerId) {
    ...
    try {
        const v = yield Visualizer.findByIdAndRemove(visualizerId).exec();
        if (!v) {
