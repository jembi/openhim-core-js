# Creating a pass through mediator
...
Currently we have support for two different generators. One for scaffolding a node.js mediator and another for scaffolding a Java mediator. You may pick which ever language you are most comfortable with.
