...
describe("Visualizer Model Tests", function() {
  ...
  return it("should save and retrieve from the visualizer collection", function(done) {
    let vis = new Visualizer(visObj);
    return vis.save(function(err) {
      if (err) { return done(err); }
      return Visualizer.findOne({name: 'TestVisualizer'}, function(err, foundVis) {
