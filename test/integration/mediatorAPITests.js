...
describe("API Integration Tests", () =>
  describe('Mediators REST API testing', function() {
    ...
    describe('*getAllMediators()', function() {
    ...
    describe('*addMediator()', function() {
        ...
        request("https://localhost:8080")
          ...
          .end(function(err, res) {
            if (err) {
              ...
              return Mediator.findOne({ urn: mediator1.urn }, function(err, res) {
                if (err) { return done(err); }
                should.exist(res);
                return done();
              });
      ...
      it('should not do anything if the mediator already exists and the version number is equal', function(done) {
        let updatedMediator = {
          urn: "urn:uuid:EEA84E13-1C92-467C-B0BD-7C480462D1ED",
          version: "1.0.0",
          ...
          request("https://localhost:8080")
            ...
            .end(function(err, res) {
              if (err) {
                ...
                return Mediator.find({ urn: mediator1.urn }, function(err, res) {
                  if (err) { return done(err); }
      ...
      it('should not do anything if the mediator already exists and the version number is less-than', function(done) {
        let updatedMediator = {
          urn: "urn:uuid:EEA84E13-1C92-467C-B0BD-7C480462D1ED",
          version: "0.9.5",
          name: "Updated Encounter Mediator"
      ...
      it('should update the mediator if the mediator already exists and the version number is greater-than', function(done) {
        let updatedMediator = {
          urn: "urn:uuid:EEA84E13-1C92-467C-B0BD-7C480462D1ED",
          version: "1.0.1",
          name: "Updated Encounter Mediator"
      ...
      it('should not update config that has already been set', function(done) {
        let mediator = {
          ...
          request("https://localhost:8080")
            ...
            .end(function(err, res) {
              if (err) {
                ...
                return Mediator.find({ urn: mediator.urn }, function(err, res) {
                  if (err) { return done(err); }
                  res.length.should.be.exactly(1);
                  res[0].name.should.be.exactly(updatedMediator.name);
      ...
      it('should reject mediators without a UUID', function(done) {
        let invalidMediator = {
          version: "0.8.2",
          name: "Patient Mediator",
          description: "Invalid mediator for testing",
      ...
      it('should reject mediators without a name', function(done) {
        let invalidMediator = {
      ...
      it('should reject mediators without a version number', function(done) {
        let invalidMediator = {
          urn: "urn:uuid:CA5B32BC-87CB-46A5-B9C7-AAF03500989A",
          name: "Patient Mediator",
          description: "Invalid mediator for testing",
      ...
      it('should reject mediators with an invalid SemVer version number (x.y.z)', function(done) {
        let invalidMediator = {
          urn: "urn:uuid:CA5B32BC-87CB-46A5-B9C7-AAF03500989A",
          name: "Patient Mediator",
          version: "0.8",
      ...
      it('should reject mediators with no endpoints specified', function(done) {
        let invalidMediator = {
          urn: "urn:uuid:CA5B32BC-87CB-46A5-B9C7-AAF03500989A",
          name: "Patient Mediator",
          version: "0.8.2",
      ...
      it('should reject mediators with an empty endpoints array specified', function(done) {
        let invalidMediator = {
          urn: "urn:uuid:CA5B32BC-87CB-46A5-B9C7-AAF03500989A",
          name: "Patient Mediator",
          version: "0.8.2",
      ...
      it('should reject mediators with invalid default config', function(done) {
        let invalidMediator = {
          urn: "urn:uuid:CA5B32BC-87CB-46A5-B9C7-AAF03500989A",
          name: "Patient Mediator",
          version: "0.8.0",
      ...
      it('should store mediator config and config definitions', function(done) {
        let validMediator = {
        ...
        return request("https://localhost:8080")
          ...
          .end(function(err, res) {
            if (err) {
              ...
              return Mediator.findOne({urn: validMediator.urn}, function(err, mediator) {
      ...
      it('should reject a mediator if the config definition does not contain a template for a struct', function(done) {
        let mediator = {
      ...
      it('should reject a mediator if the config definition contains an invalid template for a struct', function(done) {
        let mediator = {
      ...
      it('should store a mediator with config and a config definition that contains a valid struct', function(done) {
        let mediator = {
      ...
      it('should reject a mediator if the config definition does not contain a \'values\' array for an option', function(done) {
        let mediator = {
      ...
      it('should reject a mediator if the config definition contains an empty \'values\' array for an option', function(done) {
        let mediator = {
      ...
      return it('should reject a mediator if the config definition contains a non-array \'values\' field for an option', function(done) {
        let mediator = {
    ...
    describe("*removeMediator", function() {
      it("should remove an mediator with specified urn", function(done) {
        ...
        let mediator = new Mediator(mediatorDelete);
        return mediator.save(function(error, mediator) {
              ...
              .end(function(err, res) {
                if (err) {
                  ...
                  return Mediator.count((err, countAfter) =>
                    Mediator.findOne({ urn: mediator.urn }, function(error, notFoundDoc) {
    ...
    describe('*heartbeat()', function() {
          ...
          request("https://localhost:8080")
            ...
            .end(function(err, res) {
              if (err) {
                ...
                return Mediator.findOne({urn: mediator1.urn}, function(err, mediator) {
                  if (err) {
                    return done(err);
                  }
      ...
      it('should return config if the config was updated since the last heartbeat', done =>
        new Mediator(mediator1).save(function() {
          let now = new Date();
          let prev = new Date();
          let update = {
            config: {
    ...
    describe('*setConfig()', function() {
      ...
      it('should set the current config for a mediator and return a 200 status', function(done) {
      ...
      return it('should return a 400 if the config object contains unknown keys', function(done) {
        mediator1.configDefs =
          [{
            param: "param1",
            type: "string"
    ...
    return describe('*loadDefaultChannels()', function() {
      ...
      it('should add all channels in the defaultChannelConfig property', done =>
        new Mediator(mediator1).save(function(err) {
          if (err) { return done(err); }
          return request("https://localhost:8080")
            .post("/mediators/urn:uuid:EEA84E13-1C92-467C-B0BD-7C480462D1ED/channels")
            .set("auth-username", testUtils.rootUser.email)
            ...
            .end(function(err, res) {
              if (err) { return done(err); }
              return Channel.find({}, function(err, channels) {
                if (err) { return done(err); }
