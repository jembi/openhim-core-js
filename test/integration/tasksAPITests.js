...
describe("API Integration Tests", () =>
  ...
  describe('Tasks REST Api testing', function() {
            ...
            Transaction.remove({}, () =>
              Channel.remove({}, () =>
                MongoClient.connect(config.mongo.url, function(err, db) {
                  let mongoCollection = db != null ? db.collection("jobs") : undefined;
    ...
    describe('*getTasks()', function() {
      ...
      return it('should fetch all tasks that are currently Paused', function(done) {
    ...
    describe('*addTask()', function() {
        ...
        return request("https://localhost:8080")
          ...
          .end(function(err, res) {
            if (err) {
              ...
              return Task.findOne({ $and: [ {transactions: { $elemMatch: { tid: "888888888888888888888888" } }}, { transactions: {$elemMatch: { tid: "999999999999999999999999" }} }, { transactions: {$elemMatch: { tid: "101010101010101010101010" }} } ] }, function(err, task) {
      ...
      it('should add a new task (non Admin user)', function(done) {
        let newTask =
          {tids: [ "888888888888888888888888", "999999999999999999999999", "101010101010101010101010" ]};
      ...
      it('should NOT add a new task (non Admin user - No permission for one transaction)', function(done) {
        let newTask =
      ...
      it('should NOT add a new task if there are transactions linked to disabled channels', function(done) {
        let newTask =
      ...
      it('should NOT add a new task if there are transactions linked to deleted channels (flagged)', function(done) {
        let newTask =
      ...
      it('should add a new task with status Paused if the request contains paused=true', function(done) {
        let newTask = {
        ...
        return request("https://localhost:8080")
          ...
          .end(function(err, res) {
            if (err) {
              ...
              return Task.findOne({ $and: [ {transactions: { $elemMatch: { tid: "222288888888888888888888" } }}, { transactions: {$elemMatch: { tid: "333399999999999999999999" }} }, { transactions: {$elemMatch: { tid: "444410101010101010101010" }} } ] }, function(err, task) {
      ...
      return it('should clear the transactions in a new task out of the auto retry queue', function(done) {
        let newTask =
          {tids: [ "888888888888888888888888", "999999999999999999999999" ]};

        return AutoRetry.remove({}, function(err) {
          if (err) { return done(err); }

          let retry1 = new AutoRetry({
            transactionID: ObjectId('888888888888888888888888'),
            channelID: ObjectId('222222222222222222222222'),
            requestTimestamp: new Date()
          });
          let retry2 = new AutoRetry({
            transactionID: ObjectId('999999999999999999999999'),
            channelID: ObjectId('222222222222222222222222'),
            requestTimestamp: new Date()
          });
          let retry3 = new AutoRetry({
            ...
            request("https://localhost:8080")
              ...
              .end(function(err, res) {
                if (err) {
                  ...
                  return setTimeout(( () =>
                    AutoRetry.find({}, function(err, results) {
    ...
    describe('*getTask(taskId)', function() {

      it('should fetch a specific task by ID', function(done) {
      ...
      it('should fetch a specific task by ID with limit of first 10 records', function(done) {
      ...
      it('should fetch a specific task by ID with filters ( tstatus: "Completed" )', function(done) {
      ...
      return it('should fetch a specific task by ID with filters ( tstatus: "Completed", rerunStatus: "Successful" )', function(done) {
    ...
    describe('*updateTask(taskId)', function() {

      it('should update a specific task by ID', function(done) {
        let updates = {
          status: "Completed",
        ...
        return request("https://localhost:8080")
          ...
          .end(function(err, res) {
            if (err) {
              ...
              return Task.findOne({ _id: "aaa777777bbb66cc5d4444ee" }, function(err, task) {
      ...
      return it('should not allow a non admin user to update a task', function(done) {
        let updates = {};
    ...
    return describe('*removeTask(taskId)', function() {
        ...
        request("https://localhost:8080")
          ...
          .end(function(err, res) {
            if (err) {
              ...
              return Task.find({ _id: "aaa777777bbb66cc5d4444ee" }, function(err, task) {
